...
ActiveRecord::Schema[8.1].define(version: 2026_03_26_000002) do
  create_table "mollie_pay_chargebacks", id: :string, force: :cascade do |t|
  ...
  create_table "mollie_pay_customers", id: :string, force: :cascade do |t|
    t.datetime "created_at", null: false
    t.string "mollie_id", null: false
  ...
  create_table "mollie_pay_mandates", id: :string, force: :cascade do |t|
    t.datetime "created_at", null: false
  ...
  create_table "mollie_pay_payments", id: :string, force: :cascade do |t|
    t.string "amount", default: "0", null: false
  ...
  create_table "mollie_pay_refunds", id: :string, force: :cascade do |t|
    t.string "amount", default: "0", null: false
    t.datetime "created_at", null: false
    t.string "currency", default: "EUR", null: false
    t.string "mollie_id", null: false
  ...
  create_table "mollie_pay_sales_invoices", id: :string, force: :cascade do |t|
    t.string "amount"
    t.datetime "created_at", null: false
    t.string "currency"
    t.string "customer_id", null: false
  ...
  create_table "mollie_pay_subscriptions", id: :string, force: :cascade do |t|
    t.string "amount", default: "0", null: false
    t.datetime "canceled_at"
    t.datetime "created_at", null: false
    t.string "currency", default: "EUR", null: false
